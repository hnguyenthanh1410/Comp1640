...
export class ContributionController {
	...
	@UseGuards(AuthGuardJwt, RoleGuard)
	@CheckRole(RoleName.MARKETING_COORDINATOR, RoleName.STUDENT, RoleName.MARKETING_MANAGER)
	@ApiParam({
		name: 'id',
	})
	...
	async updateSubmission(
		...
		const contribution = await this.contributionService.getContributionDetail(id);
